...
public class InventorySerializer extends AbstractSerializer<Inventory> {
    ...
    @Override
    public String toString(Inventory data) {
        String serialization = data.getSize() + ";";
        for (int i = 0; i < data.getSize(); i++) {
            ItemStack is = data.getItem(i);
            if (is != null) {
    ...
    @Override
    public Inventory fromString(Object data) {
        if (data instanceof String) {
            String invString = (String) data;
            ...
            throw new PracticeException("InventorySerializer object data is not a string?");
        }
    }
}
