package com.shawckz.ipractice.database.mongo;
...
public abstract class AutoMongo {
    ...
    public void update() {
        ...
        MongoCollection<Document> col = Practice.getDbManager().getDb().getCollection(tableName);
    ...
    public static List<AutoMongo> select(BasicDBObject search, Class<? extends AutoMongo> type) {
        ...
        MongoCollection<Document> col = Practice.getDbManager().getDb().getCollection(collectionName.name());
